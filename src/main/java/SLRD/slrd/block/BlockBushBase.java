...
public class BlockBushBase extends BlockBase implements IPlantable{

	protected static final AxisAlignedBB BUSH_AABB = new AxisAlignedBB(0.30000001192092896D, 0.0D, 0.30000001192092896D, 0.699999988079071D, 0.6000000238418579D, 0.699999988079071D);

	 protected BlockBushBase()
	    {
	        this(Material.PLANTS, "defaultBlockBushBase");
	    }

	protected BlockBushBase(Material materialIn, String name)
	{
		this(materialIn, materialIn.getMaterialMapColor(), name);
	}

	protected BlockBushBase(Material materialIn, MapColor mapColorIn, String name)
	{
		super(materialIn, mapColorIn, name);
